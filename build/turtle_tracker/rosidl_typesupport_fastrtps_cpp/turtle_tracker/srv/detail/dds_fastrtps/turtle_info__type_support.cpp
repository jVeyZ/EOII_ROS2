...
#include "turtle_tracker/srv/detail/turtle_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_tracker::srv::TurtleInfo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_tracker::srv::TurtleInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_tracker::srv::TurtleInfo_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TurtleInfo_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtle_tracker::srv::TurtleInfo_Request *>(
...
static size_t _TurtleInfo_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TurtleInfo_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TurtleInfo_Request__callbacks = {
  "turtle_tracker::srv",
  "TurtleInfo_Request",
...
static rosidl_message_type_support_t _TurtleInfo_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TurtleInfo_Request__callbacks,
...
{
  return &turtle_tracker::srv::typesupport_fastrtps_cpp::_TurtleInfo_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_tracker::srv::TurtleInfo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_tracker::srv::TurtleInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_tracker::srv::TurtleInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TurtleInfo_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtle_tracker::srv::TurtleInfo_Response *>(
...
static size_t _TurtleInfo_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TurtleInfo_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TurtleInfo_Response__callbacks = {
  "turtle_tracker::srv",
  "TurtleInfo_Response",
...
static rosidl_message_type_support_t _TurtleInfo_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TurtleInfo_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &turtle_tracker::srv::typesupport_fastrtps_cpp::_TurtleInfo_Response__handle;
}
...
static service_type_support_callbacks_t _TurtleInfo__callbacks = {
  "turtle_tracker::srv",
  "TurtleInfo",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_tracker, srv, TurtleInfo_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_tracker, srv, TurtleInfo_Response)(),
...
static rosidl_service_type_support_t _TurtleInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &turtle_tracker::srv::typesupport_fastrtps_cpp::_TurtleInfo__handle;
}

...
static const _TurtleInfo_Request_type_support_symbol_names_t _TurtleInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_tracker, srv, TurtleInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_tracker, srv, TurtleInfo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_tracker, srv, TurtleInfo_Request)() {
  return &::turtle_tracker::srv::rosidl_typesupport_c::TurtleInfo_Request_message_type_support_handle;
}
...
static const _TurtleInfo_Response_type_support_symbol_names_t _TurtleInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_tracker, srv, TurtleInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_tracker, srv, TurtleInfo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_tracker, srv, TurtleInfo_Response)() {
  return &::turtle_tracker::srv::rosidl_typesupport_c::TurtleInfo_Response_message_type_support_handle;
}
...
static const _TurtleInfo_type_support_symbol_names_t _TurtleInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_tracker, srv, TurtleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_tracker, srv, TurtleInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtle_tracker, srv, TurtleInfo)() {
  return &::turtle_tracker::srv::rosidl_typesupport_c::TurtleInfo_service_type_support_handle;
}
